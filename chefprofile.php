...
<center>
   ...
   <?php
    ...
    while($rows= mysqli_fetch_array($result))
    {
        ...
        echo "<a style='margin-right:250px;' href='chefhome.php?id=".$rows['Chef_ID']."'class ='btn btn-danger'>Back to Home Page</button></a>";
        echo "<a style='margin-left:150px;' href='editchefprofile.php?id=".$rows['Chef_ID']."' class ='btn btn-primary'>Edit</button></a>";
        echo "</tr>";
