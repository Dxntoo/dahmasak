...
<?php
	...
	else
	{
		...
		die("<script>window.location.href='ACMR.php';</script>");
	}
	?>
	<center>
	<h1 style='font-size:50px; color:white;'>Admin Edit Recipe Page: </h1>
	<h3 style='font-size:25px; color:white;'>To enlarge the boxes (drag in any direction) corners from the boxes in either the Description, Serving or Steps fields.</h3>
	<h3 style='font-size:25px; color:white;'>The "Enter" button's function to move one line down is replaced by typing <img width='50px' height='20px' src="Image/br.png"></h3>
	<form method="post" action="ACMRU.php">
