...
<link rel="stylesheet" href="css/style.css"><!--Style/Style.css-->

<?php include('inc/container.php');?>
<div class="container" style='margin-top:75px;'>		
	<h2>Feedback/Rating</h2><a href="userhome.php">Back to Search Page</a>
	<!--Here need to put php and echo Recipe_Name-->
	...
	<div class="row">
		<div class="col-sm-2" style="width:150px">
			<img class="product_image" src="<?php echo $item["Recipe_Image"]; ?>" style="width:145px;height:190px;padding-top:10px;">
		</div>
		<div class="col-sm-4">
		<h2 style="margin-top:10px;"><?php echo $item["Recipe_Name"]; ?></h2>
		<div><span class="average"><?php printf('%.1f', $average); ?> <small>/ 5</small></span> </div>
		<h4 style='font-size:17px;'><?php echo $item["Descriptions"]; ?></h4>			
		</div>		
	</div>
	<?php } ?>	
		...
		<div class="row">
			<div class="col-sm-7">
				...
				foreach($itemRating as $rating){				
					...
					if($rating['Profile_Picture']="") {
						 $rating['Profile_Picture'] = $profilePic;	
					}
				?>				
					<div class="row">
						<div class="col-sm-3">
		...
		<div class="modal-dialog">
			<div class="loginmodal-container">
				...
				<form method="post" id="loginForm" name="loginForm">
					<input type="text" name="user" placeholder="Username" required><!--This is login form-->
					<input type="password" name="pass" placeholder="Password" required>
					<input type="hidden" name="action" value="userLogin">
					<input type="submit" name="login" class="login loginmodal-submit" value="Login">					 
				</form>
				<div class="login-help">					
					<p><b>User</b> :ryan, shawn, bb <b>Password</b>: 123</p>
				</div>
			</div>
		</div>
	</div>
