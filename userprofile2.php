...
<h1 style='color:white;'>Your Profile</h1>
   ...
   <?php
    ...
    $sql= "SELECT * FROM user WHERE User_ID = $id"; //add a new sql query
    ...
    while($rows= mysqli_fetch_array($result))
    {
        ...
        echo "<a href='adminmguser.php?id=".$_GET['id']."' class ='btn btn-primary'>Back</a>";

        echo "<a style='margin-left:50px;' href='editprofile2.php?id=".$rows['User_ID']."' class ='btn btn-primary'>Edit</a>";
...
$sql = "SELECT * FROM bookmark INNER JOIN recipe ON bookmark.Recipe_ID = recipe.Recipe_ID where User_ID = $id ;";
$result = mysqli_query($conn, $sql);
