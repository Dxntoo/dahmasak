...
<center>
        ...
        <form method="post" action="updatechefprofile2.php">
            <table id=profile>
            ...
            <tr>
                ...
                <br />   
                    ...
                    <td colspan="2">
                        <br />
                        <center>
                            <input type="submit" class ="btn btn1" name="save-user" value="Update" />&nbsp;&nbsp;
                            <!-- <input type="submit" class ="btn btn2" value="Back to Previous Page" formaction="chefprofile2.php" /> -->
                            <button class="btn btn1"><a href="chefprofile2.php?id=<?=$_GET['id']?>">Back</a></button>
                    </td>
