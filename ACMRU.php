...
<?php
	...
	if(mysqli_affected_rows($conn)<=0)
	{
		...
		echo "<script>window.location.href='ACMRE.php?recipename=$recipename';</script>";
	}
		
	echo "<script>alert('Successfully updated data!');</script>";
	echo "<script>window.location.href='ACMRE.php?recipename=$recipename & categoryid=$catid';</script>";
